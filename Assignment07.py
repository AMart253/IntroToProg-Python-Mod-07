...
#   Alan Martin, 02/24/2024, Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    """
    ****** EDIT THIS ***** A person class to hold student data

    ChangeLog: (Who, When, What)
    ALan Martin, 02/24/2024
    Alan Martin, 02/24/2024
    """


# TODO Add first_name and last_name properties to the constructor (Done)
    def __init__(self, first_name: str = "", last_name: str = ""):  # Move the fields into constructors (now attributes)
        self.first_name = first_name  # Set the attribute using the property for validation
        self.last_name = last_name  # Set the attribute using the property for validation

# TODO Create a getter and setter for the first_name property (Done)

    @property
    def first_name(self):
        return self.__first_name.title()  # __ for private, .title() for title casing

    @first_name.setter
    def first_name(self, value: str):
        if value.isalpha() or value == "":  # Alphanumeric validation code
...
# TODO Create a getter and setter for the last_name property (Done)
    ...
    @property
    def last_name(self):
        return self.__last_name.title()  # __ for private, .title() for title casing
...
class Student(Person):
    """
    ****** EDIT THIS ***** A student class to hold student data
...
class FileProcessor:
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Alan Martin, 02/24/2024, added empty file variable
